...
def encabezado(c, formulario, ancho, y_inicial):
    ...
    def buscar_logo(nombre):
        posibles_rutas = [
            ...
            os.path.join(settings.BASE_DIR, 'unificador_v1', 'static', 'unificador_v1', 'img', nombre),
            os.path.join(settings.BASE_DIR, 'static', 'unificador_v1', 'img', nombre),
        ]
...
def seccion_grid_mediciones(c, formulario, x, y, ancho_total):
    ...
    """
    from unificador_v1.models.parto import ItemParto as Item, MedicionParto as Medicion
    from reportlab.platypus import Table, TableStyle, Paragraph
    from reportlab.lib.styles import getSampleStyleSheet, ParagraphStyle
...
def generar_pdf_formulario_clinico(formulario, response=None):
    ...
    from unificador_v1.models.parto import FormularioParto as Formulario, HuellaParto as Huella
