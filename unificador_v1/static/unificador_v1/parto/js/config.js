...
(function () {
    ...
    /**
     * API en el mismo origen que la página (Django sirve /api/ en el mismo host:puerto).
     * Evita CORS y errores si runserver usa 8001, tablet en red, etc.
     * Para API en otro host/puerto, usar meta api-base-url o window.API_BASE_URL.
     */
    function inferirURLBackendPorHostActual() {
        return `${window.location.origin}/parto/api`;
    }
    ...
    const Config = {
        ...
        PDF_TEMPLATE_PATH: '/static/unificador_v1/parto/templates/clinico/impresion_formulario.html',
