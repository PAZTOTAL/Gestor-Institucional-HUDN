...
def obtener_rangos_por_score(parametro_codigo):
    ...
    """
    from unificador_v1.models.meows import ParametroMEOWS as Parametro, RangoParametroMEOWS as RangoParametro
...
def generar_pdf_meows(paciente, mediciones):
    ...
    # Crear tabla principal del encabezado usando el mismo ancho útil del documento
    # para alinear márgenes con las demás secciones.
    ancho_total_util = landscape(A4)[0] - 1.6*cm
    col_widths_encabezado = [
        ancho_total_util * 0.285,  # izquierda
        ancho_total_util * 0.43,   # centro
        ancho_total_util * 0.285,  # derecha
    ]
    ...
    from unificador_v1.models.meows import ParametroMEOWS as Parametro
    ...
    try:
        ...
        from unificador_v1.models.meows import FirmaPacienteMEOWS as FirmaPaciente
