...
from unificador_v1.models.fetal import (
    ...
    ControlRecienNacidoFetal as ControlRecienNacido, 
    GlucometriaRecienNacidoFetal as GlucometriaRecienNacido,
    ControlPostpartoInmediatoFetal as ControlPostpartoInmediato, 
    HuellaBebeFetal as HuellaBebe, 
    FirmaPacienteFetal as FirmaPaciente, 
    HuellaFetal as Huella
)
from unificador_v1.serializers.fetal import (
...
class FormularioRegistroView(TemplateView):
    ...
    template_name = 'unificador_v1/fetal/registros/formulario.html'
...
def captura_huella(request):
    ...
    return render(request, "unificador_v1/fetal/captura_huella.html")
