...
def parto_home(request):
    ...
    return render(request, "unificador_v1/parto/desarrollo_frontend.html", context)
...
class PacienteViewSet(viewsets.ModelViewSet):
    ...
    def buscar_completo(self, request):
        ...
        try:
            ...
            try:
                from unificador_v1.models.meows import PacienteMEOWS as MeowsPaciente
...
def generar_pdf_formulario(request, formulario_id):
    ...
    from unificador_v1.utils.pdf_parto import generar_pdf_formulario_clinico
...
def generar_pdf_paciente(request, paciente_id):
    ...
    from unificador_v1.utils.pdf_parto import seccion_biometria
