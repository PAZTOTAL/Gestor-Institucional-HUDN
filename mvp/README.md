# MVP - Certificaci髇 de contrataci髇 por OPS (Django)
...
La aplicaci贸n consulta autom谩ticamente tablas con patr贸n `contratos_YYYY` (hasta `DB_MAX_CONTRACT_YEAR`).

Columnas m铆nimas por tabla:
