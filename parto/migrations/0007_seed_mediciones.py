...
def create_mediciones_ejemplo(apps, schema_editor):
    ...
    CampoParametro = apps.get_model('parto', 'CampoParametro')
    Medicion = apps.get_model('parto', 'Medicion')
    MedicionValor = apps.get_model('parto', 'MedicionValor')
