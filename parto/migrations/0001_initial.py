    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aseguradora', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='formularios', to='parto.aseguradora')),
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='formularios', to='parto.paciente')),
            ],
            options={
                'db_table': 'formulario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parametros', to='parto.item')),
            ],
            options={
                'db_table': 'parametro',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('formulario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mediciones', to='parto.formulario')),
                ('parametro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mediciones', to='parto.parametro')),
            ],
            options={
                'db_table': 'medicion',
                'ordering': ['-tomada_en'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('formulario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parametros_formulario', to='parto.formulario')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='formularios_items', to='parto.item')),
                ('parametro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='formularios_parametro', to='parto.parametro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unidad', models.CharField(blank=True, max_length=50, null=True)),
                ('orden', models.PositiveIntegerField(default=1)),
                ('parametro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campos', to='parto.parametro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='valores', to='parto.campoparametro')),
                ('medicion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='valores', to='parto.medicion')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='formulario',
            constraint=models.CheckConstraint(check=models.Q(('num_hoja__gt', 0)), name='num_hoja_positivo'),
        ),
        migrations.AddConstraint(
            model_name='formulario',
            constraint=models.CheckConstraint(check=models.Q(('edad_snapshot__gte', 0), ('edad_snapshot__isnull', True), _connector='OR'), name='edad_snapshot_no_negativa'),
        ),
        migrations.AddConstraint(
            model_name='formulario',
            constraint=models.CheckConstraint(check=models.Q(('edad_gestion__gte', 0), ('edad_gestion__isnull', True), _connector='OR'), name='edad_gestion_no_negativa'),
        ),
        migrations.AddConstraint(
            model_name='formulario',
            constraint=models.CheckConstraint(check=models.Q(('n_controles_prenatales__gte', 0), ('n_controles_prenatales__isnull', True), _connector='OR'), name='n_controles_no_negativo'),
        ),
