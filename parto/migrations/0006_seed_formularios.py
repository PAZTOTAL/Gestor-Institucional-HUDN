...
def create_formularios(apps, schema_editor):
    ...
    Paciente = apps.get_model('parto', 'Paciente')
    Aseguradora = apps.get_model('parto', 'Aseguradora')
    Formulario = apps.get_model('parto', 'Formulario')
    Item = apps.get_model('parto', 'Item')
    Parametro = apps.get_model('parto', 'Parametro')
    FormularioItemParametro = apps.get_model('parto', 'FormularioItemParametro')
