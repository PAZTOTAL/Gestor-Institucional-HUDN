...
class Command(BaseCommand):
    help = 'Valida la conexion a DGEMPRES99 y consulta datos de ejemplo'

    def handle(self, *args, **options):
        connection = connections['default']
        
        self.stdout.write("\n" + "="*70)
        self.stdout.write("VALIDANDO CONEXION A DGEMPRES99")
        ...
        try:
            with connection.cursor() as cursor:
                cursor.execute("""
                    ...
                    AND TABLE_CATALOG = 'DGEMPRES_NEXUS'
                    ORDER BY TABLE_NAME
                """)
        ...
        self.stdout.write("="*70)
        self.stdout.write("\nCONCLUSION: La conexion a DGEMPRES99 esta funcionando correctamente.")
