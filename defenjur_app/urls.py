...
urlpatterns = [
    ...
    path('importar/<slug:modulo>/', views.importar_modulo_excel, name='importar_excel'),
    path('template/<slug:modulo>/', views.descargar_plantilla_excel, name='descargar_plantilla'),
